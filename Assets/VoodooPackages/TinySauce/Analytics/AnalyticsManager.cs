...
namespace Voodoo.Tiny.Sauce.Internal.Analytics
{
    internal static class AnalyticsManager
    {
        ...
        internal static void TrackGameFinished(bool levelComplete, float score, string dimension1 = null, string dimension2 = null, string dimension3 = null, Dictionary<string, object> eventProperties = null)
        {
            ...
            if (dimension1 != null) levelPlaytimeEventName = string.Concat(levelPlaytimeEventName, ":", dimension1);
            if (dimension2 != null) levelPlaytimeEventName = string.Concat(levelPlaytimeEventName, ":", dimension2);
            if (dimension3 != null) levelPlaytimeEventName = string.Concat(levelPlaytimeEventName, ":", dimension3);
            if (dimension1 != null) levelPlaytimeEventName = string.Concat(levelPlaytimeEventName, ":", levelComplete.ToString());
          
            TrackCustomEvent(levelPlaytimeEventName, gameFinishedParameters.gameDuration, eventProperties);
